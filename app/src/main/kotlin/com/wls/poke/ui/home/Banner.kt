@file:OptIn(ExperimentalWearMaterialApi::class, ExperimentalFoundationApi::class)
...
class PagerSwipeState(
    ...
    val anchoredDraggableState: AnchoredDraggableState<Int> = AnchoredDraggableState(
        initialValue = 0,
        positionalThreshold = { 5f },
        velocityThreshold = { 3f },
